      ...
      <div className="animated fadeIn">
        <div className="card">
          ...
          <div className="card-body">
              ...
              <tr>
                <td>
                  <p><code className="highlighter-rouge">07:05</code></p>
                </td>
                <td>Express</td>
              </tr>
              <tr>
                <td>
                  <p><code className="highlighter-rouge">08:15</code></p>
                </td>
                <td>Semi</td>
              </tr>
              <tr>
                <td>
                  <p><code className="highlighter-rouge">09:10</code></p>
                </td>
                <td>Slow</td>
              </tr>
              <tr>
                <td>
                  <p><code className="highlighter-rouge">10:05</code></p>
                </td>
                <td>Express</td>
              </tr>
              <tr>
                <td>
                  <p><code className="highlighter-rouge">11:35</code></p>
                </td>
                <td>Express</td>
              </tr>
              <tr>
                <td>
                  <p><code className="highlighter-rouge">12:15</code></p>
                </td>
                <td>Express</td>
              </tr>
              <tr>
                <td>
                  <p><code className="highlighter-rouge">13:05</code></p>
                </td>
                <td>Slow</td>
              </tr>
              <tr>
                <td>
                  <p><code className="highlighter-rouge">14:20</code></p>
                </td>
                <td>Semi</td>
              </tr>
              <tr>
                <td>
                  <p><code className="highlighter-rouge">15:05</code></p>
                </td>
                <td>Express</td>
              </tr>
              </tbody>
